...
namespace WebApi.Tests.Recipe.Filter
{
    ...
    public class FilterRecipeInvalidTokenTests : BaseIntegrationTest
    {
        private const string REQUEST_URI = "/recipes/filter";

        private readonly string _tokenUserNotExistDatabase;

        public FilterRecipeInvalidTokenTests(MyRecipeBookApplicationFactory factory) : base(factory)
        {
